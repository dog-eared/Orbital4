 ...
 * parse. GameButtons can be horizontal or vertical, move pieces nega- tively or
 * positively along the appropriate axis and have an index respresenting their
 * location in line.
 *
...
public class GameButton extends Button {
    ...
    private void placePiece(ActionEvent e) {
        ...
        if (board.getGameWon()) {
            System.out.println("Game over! Click new game to play again");
        } else {
     ...
     * @param game
     */
    public static void setGameReference(Orbital4 game) {
        o4 = game;
    }

    /**
     * Sets the current board affected by buttons as the one given as a
     * parameter.
     *
     * @param newBoard
     */
    ...
    /**
     * Sets the graphics context to draw pieces on.
     * @param context
     */
